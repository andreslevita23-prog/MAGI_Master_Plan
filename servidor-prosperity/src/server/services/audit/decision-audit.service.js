...
export function buildDecisionAuditRecord({
  ...
  return {
    ...
    risk_state: decision?.risk_state || null,
    cluster_state: decision?.cluster_state || null,
    shadow_guardrails: decision?.shadow_guardrails || null,
    current_lot_size: decision?.current_lot_size || Number(details.lot_size || decision?.lot_size || 0),
    lot_size_source: decision?.lot_size_source || null,
    demo_mode_until: decision?.demo_mode_until || null,
    be_auto_status: decision?.be_auto_status || null,
    news_guardrail_status: decision?.news_guardrail_status || null,
